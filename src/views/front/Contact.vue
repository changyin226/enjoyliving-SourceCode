  ...
  <div class="contact-page">
    ...
    <div class="container">
      <div
        ...
        class="row justify-content-center py-5 my-5 animate__animated"
      >
        <div class="col-md-4">
          <div class="contact-info">
            ...
            <ul>
              <li class="address d-flex">
                ...
                <a
                  href="https://www.google.com.tw/maps/place/110台北市信義區信義路五段7號"
                  target="_blank"
                > 台北市信義區信義路五段7號 </a>
              </li>
        ...
        <div class="col-md-6">
          <div
            v-waypoint="{ active: true, callback: onWaypointList }"
            class="contact-form animate__animated"
          >
            <h3>聯絡我們</h3>
            <ValidationObserver
              ref="observer"
    ...
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3615.041578931471!2d121.56507676601251!3d25.032662983973047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xacc4d11dc963103c!2z5Y-w5YyXMTAx!5e0!3m2!1szh-TW!2stw!4v1616660178285!5m2!1szh-TW!2stw"
      width="100%"
      height="500"
      style="border:0;"
      allowfullscreen=""
