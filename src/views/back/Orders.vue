<template>
  <div class="orders-page">
    ...
    <table class="table mt-5" v-if="orders.length">
      <thead>
        <tr class="text-white text-center">
          <th class="d-none d-sm-table-cell">購買日期</th>
          <th>訂單編號</th>
      ...
      <tbody>
        <tr class="text-white text-center" v-for="order in sortOrder" :key="order.id"
          ...
          <td class="align-middle">
            <strong v-if="order.is_paid" class="text-secondary">已付款</strong>
    ...
    <Pagination class="my-5" v-if="orders.length" :pagination="pagination"></Pagination>
